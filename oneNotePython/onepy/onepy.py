...
class OneNote():
    ...
    def __init__(self):
        ...
        try:
            ...
            print "unicode encode error. trying to encode. can be caused by german characters....", e
            self.object_tree = cElementTree.fromstring(self.process.get_hierarchy("",4).encode("utf-8"))
...
class SectionGroup(HierarchyNode):
    ...
    def __init__ (self, xml=None, parent_node=None):
        super(SectionGroup,self).__init__()
